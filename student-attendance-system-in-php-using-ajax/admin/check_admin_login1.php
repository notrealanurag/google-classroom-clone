...
function register(){
	...
	$username    =  e($_POST['admin_user_name']);
	$email       =  e($_POST['email']);
	...
	if (empty($username)) { 
		array_push($errors, "admin_user_name is required"); 
	}
	if (empty($email)) { 
	...
	if (count($errors) == 0) {
		...
		if (isset($_POST['user_type'])) {
			...
			$query = "INSERT INTO tbl_admin (admin_user_name, email, user_type, admin_password) 
